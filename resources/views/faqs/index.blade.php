            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0 card-title d-flex align-items-center justify-content-between">{{ $title }}
                        ...
                        <a href="{{ route('app.faqs.create') }}" class="btn btn-sm btn-primary rounded-1">Add Faq</a>
                        @endif
                    </h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table-sm table-striped table-bordered table table-hover mb-0" id="blog_table">
                            <thead>
                                ...
                                <th>Created By</th>
                                <th>Created At</th>
                                @if(permission('faq-delete') || permission('faq-view') || permission('faq-edit'))
...
<script>
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{ route('app.faqs.bulk-delete') }}";
    ...
    $(document).on('click','.change_status', function(){
        ...
        var url = "{{ route('app.faqs.status-change') }}"
