            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" id="form_data">
                        ...
                        <x-form.textarea labelName="Question" name="question" value="{{ $edit->question ?? '' }}" required="required" placeholder="Enter Question"/>
                        <x-form.textarea labelName="Answer" name="answer" value="{{ $edit->answer ?? '' }}" required="required" placeholder="Enter Answer"/>
            ...
            success: function (response) {
                ...
                if (response.status == false) {
                    ...
                    if (response.status == 'success') {
                        setInterval(() => {
                            window.location.href = "{{ route('app.faqs.index') }}";
                        }, 1000);
                    }
                }
            }
