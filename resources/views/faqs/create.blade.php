            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" id="form_data">
                        ...
                        <x-form.textarea labelName="Question" name="question" required="required" placeholder="Enter Question"/>
                        <x-form.textarea labelName="Answer" name="answer" required="required" placeholder="Enter Answer"/>
