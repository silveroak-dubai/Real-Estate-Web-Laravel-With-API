                ...
                <div class="card-body">
                    <form method="POST" id="user_form">
                        ...
                        <div class="permission-box">
                            <ul id="permission">
                                <li>
                                    <input type="checkbox" class="all_checkbox" {{ $total_permission == $edit->permissions->count() ? 'checked' : '' }}  id="all" />
                                ...
                                <li>
                                    ...
                                    <ul>
                                        @foreach ($module->permissions as $permission)
                                            <li>
                                                <input type="checkbox" name="permission[]" id="permission-{{ $permission->id }}" class="permission-select-{{ $module->id }}" value="{{ $permission->id }}"
